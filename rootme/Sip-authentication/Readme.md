...
En analysant la structure des logs, on remarque que la méthode d’authentification utilisée lors du REGISTER est "PLAIN", ce qui signifie que le mot de passe est transmis en clair.
